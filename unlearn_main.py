...
# Exact forget index: if >= 0, use a single training sample as forget set
parser.add_argument('-forget_idx', type=int, default=-1, help='If >=0, perform exact forget for this sample index in the train set')
